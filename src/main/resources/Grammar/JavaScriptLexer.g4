...
Implements:                     'implements' {IsStrictMode()}?;
StrictLet:                      'let' {IsStrictMode()}?;
NonStrictLet:                   'let' {!IsStrictMode()}?;
Private:                        'private' {IsStrictMode()}?;
Public:                         'public' {IsStrictMode()}?;
Interface:                      'interface' {IsStrictMode()}?;
Package:                        'package' {IsStrictMode()}?;
Protected:                      'protected' {IsStrictMode()}?;
Static:                         'static' {IsStrictMode()}?;
Yield:                          'yield' {IsStrictMode()}?; /* */
