...
iterationStatement
    ...
    // strange, 'of' is an identifier. and p("of") not work in sometime.
    | For /* */Await? '(' (singleExpression | variableDeclarationList) identifier{p("of")}? expressionSequence ')' statement  # ForOfStatement
    ;
...
classElement
    : (Static | {n("static")}? identifier | Async)* (methodDefinition | assignable '=' objectLiteral ';')
    | emptyStatement
